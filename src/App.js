    ...
    <div className="App">
      <div className="App-content">
       ...
       <div className="logo"></div>
		...
		<main className="Main-content">			<section className="Main-content-preview">
			...
			<section className="Main-content-description">
				...
				<div className="Description-items">
					...
					<div className="image-description">
						<p>Грачи очень умные и сообразительные птицы. С помощью клюва они создают и используют простейшие орудия.
							У грачей развит рефлекс на звуки трактора.
							Услышав «тарахтение», они летят на звук – трактор пашет землю, значит, в этом месте много корма.
						</p>
					</div>
					</div>
			</section>
